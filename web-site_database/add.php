    ...
    <div class="top">
        <div class="container text-center">
            <div class="block9">
                ...
                <h1 class="card-title">Добавление</h1>
                <br>
                <div>
                    <form action="vendor/create.php" method="post">
                        <input class="form-control" id="exampleFormControlInput1" v-mode="houses.name"
                            placeholder="Наименование" type="text" name="name">
                        <br>

                        <input class="form-control" id="exampleFormControlInput2" v-mode="houses.price"
                            placeholder="Цена" type="text" name="price">
                        <br>

                        <input class="form-control" id="exampleFormControlInput3" v-mode="houses.plot_area"
                            placeholder="Площадь здания" type="text" name="plot_area">
                        <br>

                        <input class="form-control" id="exampleFormControlInput4" v-mode="houses.building_area"
                            placeholder="Площадь земли" type="text" name="building_area">
                        <br>

                        <input class="form-control" id="exampleFormControlInput5" v-mode="houses.telephone"
                            placeholder="Телефон" type="text" name="telephone">
                        <br>

                        <input class="form-control" id="exampleFormControlInput6" v-mode="houses.area"
                            placeholder="Область" type="text" name="area">
                        <br>


                        <input class="form-control" id="exampleFormControlInput7" v-mode="houses.description"
                            placeholder="Описание" type="text" name="description">
                        <br>

                        <button class="btn1" @click="saveflowers" type="submit">Сохранить</button>
                    </form>
                    <br><br>
                </div>
            </div>
